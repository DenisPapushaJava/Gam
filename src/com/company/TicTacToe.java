    ...
    protected void processMouseEvent(MouseEvent mouseEvent) {
        ...
        if (mouseEvent.getButton() == MouseEvent.BUTTON1) {
            ...
            if (field[i][j] == FIELD_EMPTY) {
                ...
                if (res != 0) {
                    if (res == FIELD_O * 3) {
                        JOptionPane.showConfirmDialog(this, "Нолики выиграли", "Победа", JOptionPane.YES_NO_CANCEL_OPTION);
                    } else if (res == FIELD_X * 3) {
                        JOptionPane.showConfirmDialog(this, "Крестики выиграли", "Победа", JOptionPane.YES_NO_CANCEL_OPTION);
                    } else {
                        JOptionPane.showConfirmDialog(this, "Ничья", "Победа", JOptionPane.YES_NO_CANCEL_OPTION);
                    }
                    initGame();
                    repaint();
                }
